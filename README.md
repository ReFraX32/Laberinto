# **Laberinto**
![LEER](https://www.agoitz.eus/wp-content/uploads/2024/03/FLECHA-HACIA-ABAJO.gif)


```python
print("En el codigo quite todo lo que no era necesario y agregue el tda_pila.")
# Si ves algo raro editalo si queres
```
